...
<header class="fixed bg-white/85 dark:bg-slate-950/85 backdrop-blur-xl flex justify-between items-center w-full px-6 py-3 max-w-full mx-auto z-50 sticky top-0">
    <div class="flex items-center space-x-6">
        <h1 class="text-xl font-bold text-blue-900 dark:text-blue-100 font-headline tracking-tight">Academic Curator</h1>
        <div class="hidden md:flex items-center space-x-6 border-l pl-6 border-slate-200/20 dark:border-slate-800/20">
            {{-- <a class="text-slate-500 dark:text-slate-400 font-body font-semibold text-sm hover:bg-slate-100/50 dark:hover:bg-slate-800/50 transition-colors px-3 py-1 rounded-lg" href="#">Home</a> --}}
            {{-- <a class="text-primary dark:text-blue-100 font-bold border-b-2 border-primary font-body text-sm px-1 py-1" href="#">Requests</a> --}}
            {{-- <a class="text-slate-500 dark:text-slate-400 font-body font-semibold text-sm hover:bg-slate-100/50 dark:hover:bg-slate-800/50 transition-colors px-3 py-1 rounded-lg" href="#">Documentation</a> --}}
        </div>
    </div>
...
<div class="relative group">
    <button class="w-8 h-8 rounded-full overflow-hidden ring-2 ring-gray-300 hover:ring-blue-500 transition-all">
        <img alt="User profile photo" class="w-full h-full object-cover" src="{{ $userImage }}"/>
    </button>
    
    <div class="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 py-2 z-50">
