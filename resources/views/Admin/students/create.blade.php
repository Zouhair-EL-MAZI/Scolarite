                ...
                <div class="max-w-4xl mx-auto space-y-6">
                        <div
                                ...
                                <div class="flex flex-col gap-2">
                                        <span class="text-xs uppercase tracking-[0.3em] text-slate-500">Admin
                                                Portal</span>
                                        <h1 class="text-3xl font-bold text-blue-950 dark:text-white">Add New Student
                                        </h1>
                                        <p class="text-sm text-slate-500">Add a student record to the system for request
                                                tracking and login access.</p>
                                </div>
                        </div>
                        ...
                        <div
                                ...
                                <form method="POST" action="{{ route('admin.students.store') }}"
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                ...
                                                <div>
                                                        <label
                                                                class="block text-sm font-medium text-slate-700 dark:text-slate-300">Apogee
                                                                Number</label>
                                        ...
                                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
                                                <a href="{{ route('admin.dashboard') }}"
                                                        class="inline-flex items-center justify-center rounded-full border border-slate-200 bg-slate-100 px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-200">Back
                                                        to dashboard</a>
                                                <button type="submit"
                                                        class="inline-flex items-center justify-center rounded-full bg-blue-950 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-900">Save
                                                        Student</button>
                                        </div>
                                </form>
                        </div>
